...
def path_list_to_dict(endpoint_resolver: EndpointResolver, presenter: str, action: str, path_values: list[str]) -> dict[str, str]:
...
def query_list_to_dict(endpoint_resolver: EndpointResolver, presenter: str, action: str, query_values: list[str]) -> dict[str, str]:
    query_dict = {}
...
def prompt_endpoint(endpoint_resolver: EndpointResolver):
    ...
    action = inquirer.prompt(question)['action']
